...
function findKeyDataInRules(rules: unknown, credentialId: string): Buffer | null {
...
function findKeyDataInContextRule(rule: unknown, credentialId: string): Buffer | null {
